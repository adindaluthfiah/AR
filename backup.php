...
<body style='margin: 0; overflow: hidden;'>
    ...
    <a-entity-camera>
        <a-scene vr-mode-ui="enabled: false" embedded arjs='sourceType: webcam; sourceWidth:1280; sourceHeight:960; displayWidth: 1280; displayHeight: 960; debugUIEnabled: true;  arjs=' debugUIEnabled: true '> 
            ...
            <?php
                if(is_array($fetchData)){      
                    foreach($fetchData as $data){
                        echo ("<a-entity gltf-model='./assets/magnemite/scene.gltf' scale='1 1 1' gps-entity-place='longitude: ".$data['longitude']."; 
                        latitude: ".$data['latitude'].";' animation-mixer/>
                        
                        <a-text value='".$data['name']."\n(".$data['longitude']." , ".$data['latitude'].")' look-at='[gps-camera]' scale='1.2 1 1' align='center' ></a-text>
