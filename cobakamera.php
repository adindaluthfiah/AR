            ...
            <?php
                if(is_array($fetchData)){      
                    foreach($fetchData as $data){
                        ...
                        <a-text value='Sitename: ".$data['name']."\n(".$data['longitude']." , ".$data['latitude'].")\n".$data['value']."\nType: loremip; Height: 100m' scale='2.8 3 3' align='center' ></a-text>
                        <a-text geometry='primitive:plane' height=100 scale='11 3.2 2.5' align='center'></a-text>
