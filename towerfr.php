            ...
            <?php
                if(is_array($fetchData)){      
                    foreach($fetchData as $data){
                        ...
                        <a-text value='Sitename:".$data['SITENAME']."\n(".$data['LONGITUDE']." , ".$data['LATITUDE'].")\n".$data['BAND_COVERAGE']."\nType: ; ".$data['TOWER_TYPE']."Height: ".$data['TOWER_HEIGHT']."m' scale='2.8 3 3' align='center' ></a-text>
                        <a-text geometry='primitive:plane' height=100 scale='11 3.5 2.5' align='center'></a-text>
